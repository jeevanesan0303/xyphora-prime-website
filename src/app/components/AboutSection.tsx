...
const terminalLines = [
  ...
  {
    text: '  mission: "Build. Innovate. Elevate."',
    delay: 2.7,
    type: "string-line",
  },
  ...
  {
    text: "▶ Ready to build your future_",
    delay: 3.3,
    type: "ready",
  },
];
...
const valueCards = [
  {
    icon: Lightbulb,
    title: "Innovation",
    sub: "Cutting-edge solutions",
  },

  {
    icon: Star,
    title: "Quality",
    sub: "Zero compromise on craft",
  },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Xyphora Prime is a
            tight-knit team of 6
            specialists from Sri
            Lanka delivering
            world-class digital
            experiences.
          </p>
