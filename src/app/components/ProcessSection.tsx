    ...
    >
      ...
      <div
        style={{
          ...
          height: "400px",
          background:
            "radial-gradient(circle, rgba(77,255,235,0.05) 0%, transparent 70%)",
          filter: "blur(70px)",
          pointerEvents: "none",
        }}
      />
          ...
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{
                  y: -6,
                  borderColor: "rgba(77,255,235,0.18)",
                }}
                style={{
              ...
              >
                ...
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    background: `radial-gradient(circle at top right, rgba(${getGlow(
                      step.color
                    )},0.08), transparent 60%)`,
                    pointerEvents: "none",
                  }}
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    marginBottom: "20px",
                    boxShadow: `0 0 24px rgba(${getGlow(
                      step.color
                    )},0.08)`,
                  }}
                >
